...
<html lang="pt-br">
  <head>
    ...
    <title>Ortomiose - Uma vida mais saudável</title>
            ...
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="#">Doenças respiratórias</a>
                  <a class="dropdown-item" href="#">Alzheimer</a>
                  <a class="dropdown-item" href="#">Parkinson</a>
                  <a class="dropdown-item" href="#">Câncer</a>
                  <a class="dropdown-item" href="#">Obesidade</a>
                </div>
              </li> 
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#showcase">Quem sou eu?</a>
              </li>       
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#pricing">Casos de sucesso</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="container">      
        <div class="row space-100">
          <div class="col-lg-6 col-md-12 col-xs-12">
            <div class="contents">
              <h2 class="head-title">Melhore sua saúde!<br>Sem remédios e de forma natural.</h2>
              <p>Diabetes, Hipertensão, Obesidade até Câncer.<br>Viva sem ser escravos de remédios e tenha uma vida saudável.</p>
              <div class="header-button">
                <a href="#" class="btn btn-border-filled">Quero saber mais</a>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="services-item text-center">
              ...
              <h4>PASSO 1</h4>
              <p>Consulta e avaliação do terreno biológico, através da Anamnese, por que é ali que podemos ver como está o seu organismo!<br /> <strong>Não adianta colocarmos água limpa em um copo sujo, correto?</strong><br /> Mudança de Hábitos Alimentares é essencial. As vezes haverá a necessidade de recomendação de uma detoxificação.</p>
            </div>
          </div>
          <!-- End Col -->
          <!-- Start Col -->
          <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="services-item text-center">
              ...
              <h4>PASSO 2</h4>
              <p>Reavaliação do terreno Biológico depois de 30 dias e modular os tratamentos. Todos os passos propostos serão realizados em um espaço de 6 meses <br />( Dependendo de cada Paciente ). Sempre prezamos pela individualidade Genética, <strong>não mantemos nossos pacientes dependentes.</strong> O objetivo é sempre resolver os problemas o mais rápido possível. </p>
            </div>
          </div>
          <!-- End Col -->
          <!-- Start Col -->
          <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="services-item text-center">
              ...
              <h4>PASSO 3</h4>
              <p>Indicações suplementares específicas para cada paciente. É preciso tirar a ‘ferrugem’ do corpo, com alimentação adequada, suplementação específica e atividade física. A consulta Ortomolecular é orientada de maneira individual, após a realização de alguns exames e uma análise completa do histórico do paciente, incluindo seus vícios, hábitos alimentares e de vida, dentre muitos outros fatores. Podemos chegar no objetivo que melhor atende cada paciente.</p>
            </div>
          </div>
          <!-- End Col -->
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-12 pl-4">
            <div class="business-item-info">
              <h3>Quem sou eu?</h3>
              <p>Me chamo Lucas Reis, especialista na oligoterapia avançada  e ortomolecular, formado pela renomada Faculdade ( Innap – Instituto Nacional de Naturopatia Aplicada ).<br />
                <br />
                Formado em Estratégias da Oligoterapia na estética. Formação em Psicoterapia Holística ( Centro de Terapias ).Formação em Aromaterapia (Portal Educação) Formação em PNL – Pracctioner<br />
                <br />
                Meu foco é atingir os objetivos dos meus clientes, com estratégias da Oligoterapia e Ortomolecular por meio da mudança de hábitos, alimentação adequada e suplementação. </p>
            </div>
          </div>
          <!-- End Col -->
